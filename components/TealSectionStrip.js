...
import Arts from "../public/art.png";

export default function ColorSectionStrip() {
  return (
    <div className="flex w-full ">
      <div className="hidden lg:block bg-amber-200 p-4 flex-grow"></div>
      <div className="bg-amber-300 w-full max-w-7xl p-4 flex-grow">
          ...
          <div className="p-4 grid grid-cols-5 text-black ">
            <div className="col-span-4">
              ...
              <p className="text-sm sm:text-base max-w-4xl">
                Student submitted poetry, artwork, photography, fiction writing,
                and other reporting on artistic news
              </p>
            </div>
